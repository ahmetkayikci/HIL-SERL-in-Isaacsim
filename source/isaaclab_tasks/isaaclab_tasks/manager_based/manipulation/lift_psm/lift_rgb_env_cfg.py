...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        #record_success_ratio = ObsTerm(func=mdp.record_success_ratio)

        #success_ratio = ObsTerm(func=mdp.observations.success_ratio)
    ...
    record: RecordGroupCfg = RecordGroupCfg()
    
    display_info: str = field(default="", metadata={"help": "Current active observation terms."}) ##
